# QA Notes — v30.2 Final Visual-System Pass

## Every page

Review each route at 1366×768, 1024×768, 768×1024, 430px, 390px, 360px and 320px:

- Overview
- Bird's-eye
- Structured
- Block — Whole project and By territory
- Waffle
- Command Index
- Territory detail for all 11 territories
- Milestones
- Register
- Dependencies
- Evidence
...
Confirm every page uses the same:

- heading hierarchy
- serif metric and number treatment
- small sans-serif operational labels
- border, radius, panel surface and gold accent
- primary, secondary, compact and filter control styles
- hover and keyboard-focus behaviour
- responsive spacing
...
- quick territory chamber and every chamber tab
- item-detail modal
- prototype-input modal
- tooltips on Block Map squares
- toast messages

For each overlay confirm:

- no white or unstyled areas
- close control is styled and visible
...
- Confirm the gradient matches the approved v20 atmosphere.
- Confirm the light movement is very slow and subtle.
- Confirm the loader clears after the application is ready.
- Confirm reduced-motion mode removes the movement.
- Confirm logo, title and progress line remain centred at all widths.

## Regression

- All routes and browser Back/Forward
- Eleven territory links
- Bird's-eye mouse wheel, touch drag and pinch zoom
- Whole-project Block Map tooltips
- Register CSV export
- Status and risk colours
- Mobile hamburger animation
- Direct territory deep links
- 200% and 400% zoom
