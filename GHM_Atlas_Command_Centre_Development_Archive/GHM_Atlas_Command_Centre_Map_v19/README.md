...
## v19 craftsmanship pass

- Preserves the v18 structure and identity
- Improves card hover states and icon motion
- Adds a persistent focus hint in Visual Map controls
- Makes dependency paths directly clickable
- Adds dependency relationship tooltips
- Adds a workstream summary band to the command chamber
- Improves information hierarchy and visual rhythm
- Makes controls sticky on larger screens
- Adds reduced-motion accessibility support
- Tightens tablet and mobile behaviour
