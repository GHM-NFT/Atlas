...
(()=>{
"use strict";
const APP_VERSION="31+ RC3.4 COMPOSITION CORRECTIONS";
...
function renderOverview(){
  ...
  const overviewBlockItems=[...items].sort((a,b)=>visualOrder[itemVisualState(a)]-visualOrder[itemVisualState(b)]||a.id.localeCompare(b.id));
...
function renderMap(){
  ...
  const anchorRadius=compact?88:120;
  const iconSize=compact?176:240;
