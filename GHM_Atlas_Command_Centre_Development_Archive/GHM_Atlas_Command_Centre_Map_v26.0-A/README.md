...
## v26.0-A — Left Navigation Refresh

This milestone integrates the approved 11-territory SVG icon set, refreshes the sticky desktop rail, and adds the approved Atlas figure at the base of the rail. Existing routes, application state, information architecture and mobile navigation are unchanged.
