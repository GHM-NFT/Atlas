...
- Full-canvas waffle overview as the opening experience
- Only the top view navigation and left workstream navigation remain
- The eleven fixed workstream icons now form the left navigation
- Every small square represents one live node/item
- Status is shown by square colour
- Red/amber risk is shown by an outline
- Hover reveals item, owner, status, risk, incoming and outgoing dependencies
- Clicking a square highlights its directly related nodes
- Clicking a workstream icon focuses that whole panel
- Clicking Home returns to the complete eleven-area overview
- Structured and Square views remain available from the top bar
